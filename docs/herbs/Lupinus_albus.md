...
categories:
  ...
  - "Herbs_that_are_commonly_seen_in_the_region_of_Acid_soils"
  - "Habit_-_Annual"
  - "Herbs_that_are_commonly_seen_in_the_region_of_Disturbed_sites"
  - "Herbs_that_are_commonly_seen_in_the_region_of_Poor_soils"
  - "Herbs_with_Seeds_used_in_medicine"
  - "Herbs_that_are_commonly_seen_in_the_region_of_Disturbed_ground"
  - "Pages without herbs images"
  - "Ayurvedic_Herbs_known_to_be_helpful_to_treat_Skin_comlaints"
...
## Photo Gallery
![](../images/Lupinus_albus_leaf.JPG)
![](../images/Lupinus_albus_ru-WP.jpg)
![](../images/Lupinus_albus_wild_Italy.JPG)

## References

## External Links
* [Lupinus albus on feedipedia.org](https://www.feedipedia.org/node/279)
* [Lupinus albus on sciencedirect.com](https://www.sciencedirect.com/topics/agricultural-and-biological-sciences/lupinus-albus)
* [Lupinus albus on pfaf.org](https://pfaf.org/user/plant.aspx?LatinName=Lupinus+albus)

## References

1. [Chemistry]
2. [Morphology]
3. [Cultivation](http://tropical.theferns.info/viewtropical.php?id=Lupinus+albus)
