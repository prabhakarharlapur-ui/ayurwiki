...
1. Storage and secretion of the hormone
1. Transport of the hormone to the target cell(s)
1. Recognition of the hormone by an associated cell membrane or intracellular receptor protein
1. Relay and amplification of the received hormonal signal via a signal transduction process: This then leads to a cellular response. The reaction of the target cells may then be recognized by the original hormone-producing cells, leading to a down-regulation in hormone production. This is an example of a homeostatic negative feedback loop.
1. Breakdown of the hormone.
